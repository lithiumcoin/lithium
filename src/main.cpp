...
// Copyright (C) 2014-2015 The Lithium developers
...
uint256 hashGenesisBlock("0x000000fcf39055b547e94e610f1008b8046f942bbb730e8b6dfa6232931902db");
static const unsigned int timeGenesisBlock = 1411788333;
                              ...
                              enum GetMinFee_mode mode) const
{
    ...
    if (fAllowFree)
    {
        if (nBlockSize == 1)
        {
            ...
            // (about 4500 LIT if made of 50 LIT inputs)
            if (nBytes < 10000)
                nMinFee = 0;
        }
        else
...
if (nHeight > 0 && nHeight <1999) {nSubsidy = .48 * COIN;}

else if (nHeight > 1998 && nHeight <175000) {nSubsidy = 48 * COIN;}

else if (nHeight > 174999 && nHeight <350000) {nSubsidy = 24 * COIN;}

else if (nHeight > 349999 && nHeight <525000) {nSubsidy = 12 * COIN;}

else if (nHeight > 524999 && nHeight <650000) {nSubsidy = 6 * COIN;}

else if (nHeight > 649999 && nHeight <800000) {nSubsidy = 3 * COIN;}

else if (nHeight > 799999 && nHeight <975000) {nSubsidy = 1.5 * COIN;}

else if (nHeight > 974999) {nSubsidy = 1 * COIN;}
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000fcf39055b547e94e610f1008b8046f942bbb730e8b6dfa6232931902db");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nNonce   = 8298496;

        if (fTestNet)
        {
            block.nTime    = 1411788333;
            block.nNonce   = 8298496;
        }
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x2a1fd3e405c93b2011b4189e97cd658b1f5ca859eba01723af28dd21f4d6c008"));
...
unsigned char pchMessageStart[4] = { 0xf4, 0xa3, 0x29, 0xd5 };
