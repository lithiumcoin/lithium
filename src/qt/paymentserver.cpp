...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click lithium: links)
...
{
    // clicking on lithium: URLs creates FileOpen events on the Mac:
